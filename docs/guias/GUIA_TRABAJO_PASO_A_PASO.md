# 📋 Cuaderno de Trabajo — Paso a Paso del 
...
├── Requisito del : Administración de Sistemas Informáticos en Red
...
✅ DNS interno resolviendo erp.odoo.com
```
...
│
└── screenshots/          # Capturas para la memoria del 
```
