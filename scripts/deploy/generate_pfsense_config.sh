...
#  con todas las reglas del proyecto .
...
# DNS Override: resuelve erp.odoo.com → host odoo-server
DNS_HOST="erp"
DNS_DOMAIN="odoo.com"
...
# Host Override: erp.odoo.com → 192.168.30.10 (host odoo-server)
...
echo "8. Verificar DNS: nslookup erp.odoo.com → ${DNS_TARGET}"
