...
-- ASIR Control de Usuarios y Seguridad en Base de Datos
--
...
COMMENT ON TABLE asir_audit_log IS
  'Tabla de auditoría de seguridad (ASIR) — Registra creaciones y cambios en tablas críticas de Odoo. Incluye snapshot JSONB del registro para trazabilidad completa. Ref: https://wiki.postgresql.org/wiki/Audit_trigger';
...
COMMENT ON TRIGGER trg_audit_new_odoo_user ON res_users IS
  'ASIR: Audita la creación de nuevos usuarios en Odoo. Registra snapshot JSONB completo en asir_audit_log.';


-- ====================================================================================
-- 4. VISTA DE CONSULTA RÁPIDA (Para usar en la defensa del )
-- ====================================================================================
...
COMMENT ON VIEW v_audit_resumen IS
  'ASIR: Vista simplificada del log de auditoría. Muestra los últimos eventos con campos extraídos del JSONB.';


-- ====================================================================================
-- USO Y COMPROBACIÓN EN LA DEFENSA DEL :
-- ====================================================================================
